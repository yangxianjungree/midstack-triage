...
def main() -> int:
    ...
    required_paths = [
        ...
        (RUNTIME_ROOT / "src" / "execution" / "remote" / "capabilities.py", "remote capabilities compatibility facade"),
        (RUNTIME_ROOT / "src" / "execution" / "remote" / "error_contract.py", "remote error contract"),
        ...
        (RUNTIME_ROOT / "src" / "execution" / "remote" / "script_capabilities.py", "remote script capability runtime"),
